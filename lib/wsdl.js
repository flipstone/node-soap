...
WSDL.prototype.namespacePrefix = function(name, namespace) {
    /*
     * name is aplaceholder to allow namespace
     * to be picked based on element name if alternate
...
WSDL.prototype.objectToXML = function(obj, name, namespace) {
    var self = this,
        parts = [],
        ns = self.namespacePrefix(name, namespace);
